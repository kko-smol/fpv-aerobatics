...
int TrackScene::initEgl()
{
    ...
    for (size_t i=0; i<_track->points().size();++i){
        ...
        glm::mat4 rmr = glm::rotate(glm::mat4(1.0),pt.ang().x,glm::vec3(0.0,1.0,0.0));
        glm::mat4 rmp = glm::rotate(glm::mat4(1.0),pt.ang().y,glm::vec3(1.0,0.0,0.0));
        glm::mat4 rmh = glm::rotate(glm::mat4(1.0),pt.ang().z,glm::vec3(0.0,0.0,1.0));
